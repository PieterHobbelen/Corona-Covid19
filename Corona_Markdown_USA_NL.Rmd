...
```{r, echo=FAlSE, message=FALSE}
corona_nl_total_province %>% ggplot(aes(population_provices_NL, confirmed_cases_NL))
#corona_nl_total_province %>% ggplot(aes(population_provices_NL/10^6, confirmed_cases_NL, label = province_NL)) + geom_smooth(method = "lm") + ggtitle("Figure e; Corona patients in the 12 provinces in The Netherlands") + ylab("Confirmed cases") + xlab("Population of the province * 1.000.000") + geom_label_repel(aes(color = region_NL)) + geom_point(aes(color = region_NL)) + theme(legend.position = "right", legend.background = element_rect(fill="lightblue", size=0.5, linetype = "solid", color = "darkblue")) + labs(color = "Regions The Netherlands: ")
```
...
#corona_nl_total_province %>% ggplot(aes(population_provices_NL/10^6, confirmed_cases_NL, label = province_NL)) + geom_smooth(method = "gam") + geom_label_repel(aes(color = region_NL)) + scale_x_continuous(trans = "log10") + geom_point(aes(color = region_NL)) + ggtitle("Figure f; Corona patients in the 12 provinces in The Netherlands") + ylab("Confirmed cases") + xlab("Population of the province * 1.000.000, log 10 scale") + scale_x_continuous(trans = "log10")  + theme(legend.position = "right", legend.background = element_rect(fill="lightblue", size=0.5, linetype = "solid", color = "darkblue")) + labs(color = "Regions The Netherlands: ")
```
